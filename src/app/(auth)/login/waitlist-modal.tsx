...
import { MaskedTextField, SelectField, Textarea, TextField } from "@/components/textfield";
    ...
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed inset-0 z-50 flex items-center justify-center px-4">
        <motion.div
          ...
          initial={alreadySubmitted ? "success" : "form"}
          animate={alreadySubmitted ? "success" : "form"}
            ...
            <>
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="flex flex-col gap-2 w-full">
                    <label className="text-neutral-950 font-araboto font-medium">
                      Rede social <span className="text-red-secondary-500">*</span>
                    </label>
                    <TextField
