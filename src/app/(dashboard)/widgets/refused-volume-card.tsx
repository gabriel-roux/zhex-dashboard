...
/* COMPONENT                                                           */
/* ------------------------------------------------------------------ */
export function RefusedVolumeWidget() {
  return (
    <div className="w-full h-[380px] bg-white border border-neutral-200 rounded-lg py-5 px-4 flex flex-col gap-4">
      ...
      <header className="flex items-start justify-between">
        <h3 className="text-neutral-1000 font-araboto text-lg flex items-center gap-2 font-medium">
          <SmileyXEyesIcon size={22} weight="bold" className="-mt-0.5" />
          Volume Recusado
        </h3>
      ...
      <div className="flex-1">
        <ResponsiveContainer width="100%" height={210}>
          ...
          >
            ...
            {/* Gradientes ---------------------------------------- */}
            <defs>
              <linearGradient id="lineCurrent" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#FF8F90" stopOpacity={0.9} />
                <stop offset="100%" stopColor="#FF8F90" stopOpacity={0.3} />
              </linearGradient>
              <linearGradient id="linePrevious" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#D84545" stopOpacity={0.8} />
                <stop offset="100%" stopColor="#D84545" stopOpacity={0.2} />
              </linearGradient>
            </defs>
