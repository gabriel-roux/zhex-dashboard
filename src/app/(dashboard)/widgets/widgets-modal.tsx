  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content
        ...
        className="fixed left-1/2 top-1/2 h-[70vh] w-[1590px] -translate-x-1/2 z-50 -translate-y-1/2 rounded-2xl bg-white border border-neutral-200 shadow-xl flex flex-col overflow-hidden"
      >
