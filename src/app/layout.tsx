...
const arabotoSans = localFont({
  src: [
    { path: "../assets/fonts/Araboto-Thin.ttf",    weight: "200", style: "normal" },
    { path: "../assets/fonts/Araboto-Light.ttf", weight: "300", style: "normal" },
    { path: "../assets/fonts/Araboto-Normal.ttf",    weight: "400", style: "normal" },
    { path: "../assets/fonts/Araboto-Medium.ttf",    weight: "500", style: "normal" },
    { path: "../assets/fonts/Araboto-Bold.ttf",    weight: "700", style: "normal" },
    { path: "../assets/fonts/Araboto-Black.ttf",    weight: "900", style: "normal" },
  ],
...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Equipe Zhex -> Gabriel Fonseca", url: "https://zhex.io/about" }],
  creator: "Zhex",
  publisher: "Zhex",
  robots: {
    index: true,
